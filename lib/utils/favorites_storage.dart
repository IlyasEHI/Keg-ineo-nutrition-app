...
class FavoritesStorage {
  ...
  static Future<void> removeForProfile(String profileId, String recipeId) async {
    final favorites = await loadForProfile(profileId);
    favorites.removeWhere((recipe) => recipe.id == recipeId);
    await saveForProfile(profileId, favorites);
  }
}
